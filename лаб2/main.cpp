...
void mEnu_init(){
    Menu_AddButton("Exemp", 50, 200, 100, 30, 2);
                   ...
                   int nCmdShow)
{
    ...
    Load_Texture( "Δενθρ.png", &bg, GL_REPEAT, GL_REPEAT, GL_NEAREST);
    //Load_Texture( "background.png", &dd, GL_REPEAT, GL_REPEAT, GL_NEAREST);
